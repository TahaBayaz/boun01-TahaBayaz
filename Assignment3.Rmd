...
For the best glm model, we can calculate the R^2 value for understanding the performance. It can be calculate easily with `1 - (Residual deviance / Null deviance)` according to this [link](https://stats.stackexchange.com/questions/46345/how-to-calculate-goodness-of-fit-in-glm-r).

```{r}
model_glm2_r2 = 1 - (5343.6 / 42126.8)
model_glm2_r2
```

We got `r model_glm2_r2` R^2 value for this model. We can use it when comparing with other models.
...
If we want to compare the best tree model with best glm model, we need to compare the R^2 values for these models.

```{r}
model_rpart2_r2 > model_glm2_r2
```
